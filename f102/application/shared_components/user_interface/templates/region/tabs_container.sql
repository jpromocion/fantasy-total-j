...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(17079374131935149)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17079637111935149)
,p_plug_template_id=>wwv_flow_imp.id(17079374131935149)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17079955422935150)
,p_plug_template_id=>wwv_flow_imp.id(17079374131935149)
,p_name=>'Tabs'
