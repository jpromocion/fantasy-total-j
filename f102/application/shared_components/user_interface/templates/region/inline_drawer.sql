...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(17062464567935141)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17062774351935141)
,p_plug_template_id=>wwv_flow_imp.id(17062464567935141)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17063060479935141)
,p_plug_template_id=>wwv_flow_imp.id(17062464567935141)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17063316035935141)
,p_plug_template_id=>wwv_flow_imp.id(17062464567935141)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17063688418935141)
,p_plug_template_id=>wwv_flow_imp.id(17062464567935141)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17063953855935142)
,p_plug_template_id=>wwv_flow_imp.id(17062464567935141)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17064212070935142)
,p_plug_template_id=>wwv_flow_imp.id(17062464567935141)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17064558581935142)
,p_plug_template_id=>wwv_flow_imp.id(17062464567935141)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17064854945935142)
,p_plug_template_id=>wwv_flow_imp.id(17062464567935141)
,p_name=>'Sub Regions'
