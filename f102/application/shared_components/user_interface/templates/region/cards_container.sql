...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(17040854231935129)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17041141897935129)
,p_plug_template_id=>wwv_flow_imp.id(17040854231935129)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17041403687935129)
,p_plug_template_id=>wwv_flow_imp.id(17040854231935129)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17041755792935130)
,p_plug_template_id=>wwv_flow_imp.id(17040854231935129)
,p_name=>'Sub Regions'
