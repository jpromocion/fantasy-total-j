...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(16997868089935092)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16998195176935097)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16998442473935098)
,p_page_template_id=>wwv_flow_imp.id(16997868089935092)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(16998737730935098)
,p_page_template_id=>wwv_flow_imp.id(16997868089935092)
