...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(17042708691935130)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17043044336935130)
,p_plug_template_id=>wwv_flow_imp.id(17042708691935130)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17043354600935130)
,p_plug_template_id=>wwv_flow_imp.id(17042708691935130)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17043673233935130)
,p_plug_template_id=>wwv_flow_imp.id(17042708691935130)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17043951556935131)
,p_plug_template_id=>wwv_flow_imp.id(17042708691935130)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17044292290935131)
,p_plug_template_id=>wwv_flow_imp.id(17042708691935130)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17044514596935131)
,p_plug_template_id=>wwv_flow_imp.id(17042708691935130)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17044848120935131)
,p_plug_template_id=>wwv_flow_imp.id(17042708691935130)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17045185314935131)
,p_plug_template_id=>wwv_flow_imp.id(17042708691935130)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17045492601935131)
,p_plug_template_id=>wwv_flow_imp.id(17042708691935130)
,p_name=>'Sub Regions'
