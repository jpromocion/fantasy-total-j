...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(17111360161935165)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17111631987935166)
,p_plug_template_id=>wwv_flow_imp.id(17111360161935165)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17111947498935166)
,p_plug_template_id=>wwv_flow_imp.id(17111360161935165)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17112284621935166)
,p_plug_template_id=>wwv_flow_imp.id(17111360161935165)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17112531499935166)
,p_plug_template_id=>wwv_flow_imp.id(17111360161935165)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17112824847935166)
,p_plug_template_id=>wwv_flow_imp.id(17111360161935165)
,p_name=>'Sub Regions'
