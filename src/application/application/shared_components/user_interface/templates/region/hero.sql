...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(17103768164935162)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17104056777935162)
,p_plug_template_id=>wwv_flow_imp.id(17103768164935162)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17104349070935162)
,p_plug_template_id=>wwv_flow_imp.id(17103768164935162)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17104647514935162)
,p_plug_template_id=>wwv_flow_imp.id(17103768164935162)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17104968578935162)
,p_plug_template_id=>wwv_flow_imp.id(17103768164935162)
,p_name=>'Sub Regions'
