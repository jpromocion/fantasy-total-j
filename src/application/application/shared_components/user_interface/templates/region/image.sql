...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(17057046974935138)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17057380774935138)
,p_plug_template_id=>wwv_flow_imp.id(17057046974935138)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(17057642891935139)
,p_plug_template_id=>wwv_flow_imp.id(17057046974935138)
,p_name=>'Sub Regions'
