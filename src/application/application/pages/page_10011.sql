...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(17208020147935303)
,p_name=>'Manage User Access'
...
,p_owner=>'CURSO'
,p_internal_uid=>17208020147935303
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(17208442152935310)
,p_db_column_name=>'ID'
,p_display_order=>0
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(17208845523935313)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(17209291501935313)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(17210801714935317)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'172109'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17211747450935319)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(17207242118935302)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17212153986935319)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17212550410935319)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(17207311095935302)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(17207242118935302)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(17213108062935320)
,p_event_id=>wwv_flow_imp.id(17207311095935302)
,p_event_result=>'TRUE'
