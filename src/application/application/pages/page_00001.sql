...
'),',
'-- jugadores del equipo (filtrado por temporada y equipo)',
'team_players AS (',
'  SELECT pl.id player_id,',
'         pl.idfantasypositionbase',
'  FROM FANTASY_PLAYER pl',
'  WHERE pl.idfantasyworkteam = :P1_EQUIPOFANTASY',
...
'         tp.idfantasypositionbase',
'  FROM team_players tp',
'',
'  UNION',
'',
'  -- posiciones adicionales registradas en la tabla hija (solo para jugadores del equipo)',
...
'),',
'-- puntos por jugador PARA CADA una de sus posiciones posibles para la temporada/equipo por semana',
'players_points AS (',
'  SELECT pp.player_id,',
...
'  JOIN FANTASY_POINT pt',
'    ON pt.idfantasyplayer = pp.player_id',
...
'         fppa.idfantasypositionbase',
'  FROM FANTASY_PLAYER_POSITION_BASE_ADI fppa',
'  JOIN team_players tp ON tp.player_id = fppa.idfantasyplayer',
'),',
'-- puntos por jugador PARA CADA una de sus posiciones posibles para la temporada/equipo por semana',
'players_points AS (',
'  SELECT pp.player_id,',
...
'  JOIN FANTASY_POINT pt',
'    ON pt.idfantasyplayer = pp.player_id',
'   AND pt.idfantasyseason = :P1_TEMPORADA',
'   AND pt.idfantasyworkteam = :P1_EQUIPOFANTASY',
'),',
unistr('-- combinamos semanas x posiciones y emparejamos con jugadores elegibles para esa posici\00F3n'),
'eligible AS (',
