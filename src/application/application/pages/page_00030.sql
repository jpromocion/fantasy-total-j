...
,p_ajax_items_to_submit=>'P30_TEMPORADA,P30_EQUIPOFANTASY'
...
'<h2>Proyecciones para Resto de Temporada (Rest Of Season)</h2>',
...
wwv_flow_imp_page.create_ig_report_filter(
 p_id=>wwv_flow_imp.id(37873179060501979)
,p_report_id=>wwv_flow_imp.id(75378833307619167)
,p_type=>'COLUMN'
,p_column_id=>wwv_flow_imp.id(75501837351478519)
,p_operator=>'EQ'
...
,p_triggering_element=>'P30_EQUIPOFANTASY,P30_TEMPORADA'
,p_bind_type=>'bind'
