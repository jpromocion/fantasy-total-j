...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(33532089048593837)
,p_plug_name=>'total-anual'
,p_title=>'Totalizado Anual'
,p_region_template_options=>'#DEFAULT#:is-collapsed:t-Region--scrollBody'
,p_plug_template=>2664334895415463485
,p_plug_display_sequence=>40
,p_location=>null
,p_plug_header=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('<p>Los valores se muestran totalizados por a\00F1o, sumando lo existente de todos los equipos fantasy distintos.</p>'),
unistr('<p>Esto no deja mucho sentido a "Puntos Win" y "Puntos Fantasy": proveedores que participan en ofensiva/defensiva, siempre tendr\00E1n valores absolutos mejores.</p>'),
unistr('<p>En cambio el "% acierto" al ser un valor relativizado, si es m\00E1s relevante. Pero tambi\00E9n tenemos proveedor solo de defensiva... que a priori es m\00E1s factible que tenga mejor % acierto</p>'),
unistr('<p><b>Por todo ello, dejamos el bloque, pero son m\00E1s relevantes los datos totalizados anualmente por equipo individual.</b></p>')))
...
,p_plug_name=>'total-puntos-win'
,p_title=>'Puntos Win'
,p_parent_plug_id=>wwv_flow_imp.id(33532089048593837)
...
,p_plug_name=>'total-puntos-win-datos-top'
,p_title=>'Datos - Top'
...
,p_plug_name=>'total-puntos-win-datos'
,p_title=>'Datos'
...
,p_plug_name=>'total-puntos-fantasy'
...
,p_plug_name=>'total-puntos-fantasy-datos-top'
,p_title=>'Datos - Top'
...
,p_plug_name=>'total-puntos-fantasy-datos'
,p_title=>'Datos'
...
,p_name=>'total-puntos-fantasy-top'
,p_title=>'Top'
,p_parent_plug_id=>wwv_flow_imp.id(20206281171424134)
,p_template=>2100526641005906379
,p_display_sequence=>30
...
'  SELECT DISTINCT pl.id player_id,',
...
'  JOIN FANTASY_PLAYER pl ON pl.id = fppa.idfantasyplayer',
'),',
'-- puntos por jugador por season/workteam/week',
'players_points AS (',
'  SELECT pp.player_id,',
'         pp.idfantasypositionbase,',
'         pp.idfantasyworkteam,',
'         pp.idfantasyseason,',
'         pt.week,',
'         pt.fantasypoints',
'  FROM players_positions pp',
'  JOIN FANTASY_POINT pt ON pt.idfantasyplayer = pp.player_id',
'  WHERE pt.idfantasyseason = pp.idfantasyseason',
'    AND pt.idfantasyworkteam = pp.idfantasyworkteam',
'),',
...
,p_plug_name=>'total-acierto-datos-top'
,p_title=>'Datos - Top'
...
,p_plug_name=>'total-acierto-datos'
,p_title=>'Datos'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(33532574622593842)
,p_plug_name=>'tota-anual-equipo'
,p_title=>'Total Anualizado por cada Equipo'
,p_region_template_options=>'#DEFAULT#:is-expanded:t-Region--scrollBody'
,p_plug_template=>2664334895415463485
,p_plug_display_sequence=>10
,p_location=>null
,p_plug_header=>unistr('<p>Se selecciona un equipo fantasy concreto, y muestra la progresi\00F3n de sus datos por anualidad.</p>')
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(33533122692593848)
,p_plug_name=>'anual-acierto'
,p_title=>'% acierto'
,p_parent_plug_id=>wwv_flow_imp.id(33532574622593842)
,p_region_template_options=>'#DEFAULT#:js-showMaximizeButton:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>10
...
,p_location=>null
,p_plug_source_type=>'NATIVE_JET_CHART'
,p_ajax_items_to_submit=>'P5_EQUIPOFANTASY'
);
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(33533255343593849)
,p_region_id=>wwv_flow_imp.id(33533122692593848)
,p_chart_type=>'scatter'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(33533329543593850)
,p_chart_id=>wwv_flow_imp.id(33533255343593849)
,p_seq=>10
,p_name=>'ProveedorPorcenAcierto'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'-- Chart: % acierto promedio por proveedor por temporada (Scatter) -> Filtrando equipo fantasy pantalla',
'-- Series Name = proveedor_serie, Label = LABEL_X, X = TEMPORADA_X, Y = PUNTOS_Y, Tooltip = TOOLTIP',
'WITH',
'-- pares season/workteam/week con puntos',
'season_team_weeks AS (',
'  SELECT DISTINCT fp.idfantasyseason, fp.idfantasyworkteam, fp.week',
'  FROM FANTASY_POINT fp',
'  where fp.idfantasyworkteam = :P5_EQUIPOFANTASY',
'),',
'-- posiciones por workteam (ordenadas)',
'positions AS (',
'  SELECT pw.idfantasyworkteam,',
...
'  FROM FANTASY_POSITION_WORKTEAM pw',
'  JOIN FANTASY_POSITION p ON pw.idfantasyposition = p.id',
'  where pw.idfantasyworkteam = :P5_EQUIPOFANTASY',
'),',
unistr('-- posiciones posibles por jugador: posici\00F3n base + posiciones adicionales en la tabla hija'),
'players_positions AS (',
unistr('  -- posici\00F3n base del jugador (solo jugadores del workteam)'),
'  SELECT DISTINCT pl.id player_id,',
'         pl.idfantasypositionbase,',
'         pl.idfantasyworkteam,',
'         pl.idfantasyseason',
'  FROM FANTASY_PLAYER pl',
'  WHERE pl.idfantasyworkteam = :P5_EQUIPOFANTASY',
'',
'  UNION',
'',
'  -- posiciones adicionales registradas en la tabla hija (solo para jugadores del workteam)',
'  SELECT DISTINCT fppa.idfantasyplayer AS player_id,',
'         fppa.idfantasypositionbase,',
'         pl.idfantasyworkteam,',
'         pl.idfantasyseason',
...
'  WHERE pt.idfantasyseason = pp.idfantasyseason',
'    AND pt.idfantasyworkteam = pp.idfantasyworkteam',
'    and pt.idfantasyworkteam = :P5_EQUIPOFANTASY',
'),',
unistr('-- eligible: por cada season/workteam/week + posici\00F3n los jugadores elegibles'),
'eligible AS (',
'  SELECT stw.idfantasyseason,',
...
'     AND pp.idfantasyseason = stw.idfantasyseason',
'     AND pp.week = stw.week',
'     and stw.idfantasyworkteam = :P5_EQUIPOFANTASY',
'),',
'ordered_positions AS (',
'  SELECT DISTINCT idfantasyworkteam, pos_id, rn FROM positions where idfantasyworkteam = :P5_EQUIPOFANTASY',
'),',
'-- CTE recursivo por (season,workteam,week) para elegir por orden el mejor jugador no usado',
'ideal_recursive (',
'  idfantasyseason, idfantasyworkteam, week, rn, pos_id, player_id, points, selected_players',
...
'  -- anchor rn = 1',
'  SELECT e.idfantasyseason, e.idfantasyworkteam, e.week, e.rn, e.pos_id,',
'    (SELECT player_id FROM (SELECT player_id, fantasypoints FROM eligible ee WHERE ee.idfantasyseason = e.idfantasyseason AND ee.idfantasyworkteam = e.idfantasyworkteam AND ee.week = e.week AND ee.pos_id = e.pos_id',
'      and e.idfantasyworkteam = :P5_EQUIPOFANTASY',
'      ORDER BY fantasypoints DESC, player_id) WHERE rownum = 1),',
'    NVL((SELECT fantasypoints FROM (SELECT player_id, fantasypoints FROM eligible ee WHERE ee.idfantasyseason = e.idfantasyseason AND ee.idfantasyworkteam = e.idfantasyworkteam AND ee.week = e.week AND ee.pos_id = e.pos_id and e.idfantasyworkteam = :'
||'P5_EQUIPOFANTASY ORDER BY fantasypoints DESC, player_id) WHERE rownum = 1),0),',
'    NVL(TO_CHAR((SELECT player_id FROM (SELECT player_id FROM eligible ee WHERE ee.idfantasyseason = e.idfantasyseason AND ee.idfantasyworkteam = e.idfantasyworkteam AND ee.week = e.week AND ee.pos_id = e.pos_id and e.idfantasyworkteam = :P5_EQUIPOFA'
||'NTASY ORDER BY fantasypoints DESC, player_id) WHERE rownum = 1)), '''')',
'  FROM (SELECT DISTINCT idfantasyseason, idfantasyworkteam, week, rn, pos_id FROM eligible WHERE idfantasyworkteam = :P5_EQUIPOFANTASY) e',
'  WHERE e.rn = 1',
'',
'  UNION ALL',
'',
...
'  SELECT i.idfantasyseason, i.idfantasyworkteam, i.week, op.rn, op.pos_id,',
'    (SELECT player_id FROM (SELECT player_id, fantasypoints FROM eligible ee WHERE ee.idfantasyseason = i.idfantasyseason AND ee.idfantasyworkteam = i.idfantasyworkteam AND ee.week = i.week AND ee.pos_id = op.pos_id AND instr('',''||NVL(i.selected_play'
||'ers,'''')||'','', '',''||ee.player_id||'','') = 0 and i.idfantasyworkteam = :P5_EQUIPOFANTASY ORDER BY fantasypoints DESC, player_id) WHERE rownum = 1),',
'    NVL((SELECT fantasypoints FROM (SELECT player_id, fantasypoints FROM eligible ee WHERE ee.idfantasyseason = i.idfantasyseason AND ee.idfantasyworkteam = i.idfantasyworkteam AND ee.week = i.week AND ee.pos_id = op.pos_id AND instr('',''||NVL(i.selec'
||'ted_players,'''')||'','', '',''||ee.player_id||'','') = 0 and i.idfantasyworkteam = :P5_EQUIPOFANTASY ORDER BY fantasypoints DESC, player_id) WHERE rownum = 1),0),',
'    NVL(i.selected_players,'''') ||',
'      CASE',
'        WHEN (SELECT player_id FROM (SELECT player_id FROM eligible ee WHERE ee.idfantasyseason = i.idfantasyseason AND ee.idfantasyworkteam = i.idfantasyworkteam AND ee.week = i.week AND ee.pos_id = op.pos_id AND instr('',''||NVL(i.selected_players,'''''
||')||'','', '',''||ee.player_id||'','') = 0 and i.idfantasyworkteam = :P5_EQUIPOFANTASY ORDER BY fantasypoints DESC, player_id) WHERE rownum = 1) IS NOT NULL',
'        THEN '','' || TO_CHAR((SELECT player_id FROM (SELECT player_id FROM eligible ee WHERE ee.idfantasyseason = i.idfantasyseason AND ee.idfantasyworkteam = i.idfantasyworkteam AND ee.week = i.week AND ee.pos_id = op.pos_id AND instr('',''||NVL(i.sele'
||'cted_players,'''')||'','', '',''||ee.player_id||'','') = 0 and i.idfantasyworkteam = :P5_EQUIPOFANTASY ORDER BY fantasypoints DESC, player_id) WHERE rownum = 1))',
'        ELSE ''''',
'      END',
'  FROM ideal_recursive i',
'  JOIN ordered_positions op ON op.idfantasyworkteam = i.idfantasyworkteam and i.idfantasyworkteam = :P5_EQUIPOFANTASY AND op.rn = i.rn + 1',
'),',
'ideal_lineup AS (',
'  SELECT idfantasyseason, idfantasyworkteam, week, pos_id, player_id, NVL(points,0) points',
'  FROM ideal_recursive',
'  where idfantasyworkteam = :P5_EQUIPOFANTASY',
'),',
'ideal_total AS (',
'  SELECT idfantasyseason, idfantasyworkteam, week, SUM(points) AS ideal_points',
'  FROM ideal_lineup',
...
'   AND pr.week = fp.week',
'   AND pr.idfantasyplayer = fp.idfantasyplayer',
'   and pr.idfantasyworkteam = :P5_EQUIPOFANTASY',
'  GROUP BY pr.idfantasysupplier, pr.idfantasyseason, pr.idfantasyworkteam, pr.week',
'),',
'-- pct semanal por supplier (solo donde ideal_points > 0)',
'week_pct AS (',
...
'   AND it.idfantasyworkteam = s.idfantasyworkteam',
'   AND it.week = s.week',
'   and it.idfantasyworkteam = :P5_EQUIPOFANTASY',
')',
'-- Resultado: promedio de % semanales por proveedor por temporada',
'SELECT',
'  su.name proveedor_serie,',
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(35644650001501301)
,p_chart_id=>wwv_flow_imp.id(33533255343593849)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_min=>2021
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(35644784730501302)
,p_chart_id=>wwv_flow_imp.id(33533255343593849)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(35645025544501305)
,p_plug_name=>'anual-acierto-datos-top'
,p_title=>'Datos - Top'
,p_parent_plug_id=>wwv_flow_imp.id(33533122692593848)
,p_region_template_options=>'#DEFAULT#:is-collapsed:t-Region--scrollBody'
,p_plug_template=>2664334895415463485
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(35645139368501306)
,p_plug_name=>'anual-acierto-datos'
,p_title=>'Datos'
,p_parent_plug_id=>wwv_flow_imp.id(35645025544501305)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>10
...
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'-- Tabla: % acierto promedio por temporada / equipo / proveedor -> Filtrando equipo fantasy pantalla',
'WITH',
'-- mismos CTEs que en el chart: season_team_weeks, positions, players_points, eligible, ideal_recursive, ideal_total, supplier_week_points, week_pct',
'season_team_weeks AS (',
'  SELECT DISTINCT fp.idfantasyseason, fp.idfantasyworkteam, fp.week',
...
'JOIN FANTASY_SEASON fs ON fs.id = w.idfantasyseason',
'WHERE w.pct IS NOT NULL',
' and w.idfantasyworkteam = :P5_EQUIPOFANTASY',
'GROUP BY fs.season, wt.workteam, su.name',
'ORDER BY fs.season DESC, wt.workteam, porcentaje DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P5_EQUIPOFANTASY'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(35645263337501307)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_enable_mail_download=>'Y'
,p_owner=>'JORTRI'
,p_internal_uid=>35645263337501307
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35645341641501308)
,p_db_column_name=>'TEMPORADA'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Temporada'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35645420651501309)
,p_db_column_name=>'EQUIPO'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Equipo'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35645556002501310)
,p_db_column_name=>'PROVEEDOR'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Proveedor'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35645641434501311)
,p_db_column_name=>'PORCENTAJE'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Porcentaje'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35645779227501312)
,p_db_column_name=>'SEMANAS_EVALUADAS'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Semanas Evaluadas'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(35661122773746692)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'356612'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'TEMPORADA:PROVEEDOR:PORCENTAJE:SEMANAS_EVALUADAS:'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(35645848139501313)
,p_name=>'anual-acierto-top'
,p_title=>'Top'
,p_parent_plug_id=>wwv_flow_imp.id(35645025544501305)
,p_template=>2100526641005906379
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(35645997081501314)
,p_query_column_id=>1
,p_column_alias=>'PROVEEDOR'
,p_column_display_sequence=>10
,p_column_heading=>'Proveedor'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(35646093188501315)
,p_query_column_id=>2
,p_column_alias=>'PORCENTAJE_ACIERTO'
,p_column_display_sequence=>20
,p_column_heading=>'Porcentaje Acierto'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(35646199919501316)
,p_query_column_id=>3
,p_column_alias=>'SEMANAS_EVALUADAS'
,p_column_display_sequence=>30
,p_column_heading=>'Semanas Evaluadas'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(35646405496501319)
,p_plug_name=>'anual-puntos-win'
,p_title=>'Puntos Win'
,p_parent_plug_id=>wwv_flow_imp.id(33532574622593842)
,p_region_template_options=>'#DEFAULT#:js-showMaximizeButton:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(35646597666501320)
,p_region_id=>wwv_flow_imp.id(35646405496501319)
,p_chart_type=>'scatter'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(35646642833501321)
,p_chart_id=>wwv_flow_imp.id(35646597666501320)
,p_seq=>10
,p_name=>'ProveedorPuntoWin'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'WHERE FV.IDFANTASYSEASON = FS.ID',
'  AND FV.IDFANTASYSUPPLIER = su.ID',
'  and FV.IDFANTASYWORKTEAM = :P5_EQUIPOFANTASY',
'GROUP BY su.NAME, su.colour, FS.SEASON'))
,p_ajax_items_to_submit=>'P5_EQUIPOFANTASY'
,p_series_name_column_name=>'PROVEEDOR_SERIE'
,p_items_x_column_name=>'TEMPORADA_X'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(35646730029501322)
,p_chart_id=>wwv_flow_imp.id(35646597666501320)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_min=>2021
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(35646870922501323)
,p_chart_id=>wwv_flow_imp.id(35646597666501320)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(35646988954501324)
,p_plug_name=>'anual-puntos-win-datos-top'
,p_title=>'Datos - Top'
,p_parent_plug_id=>wwv_flow_imp.id(35646405496501319)
,p_region_template_options=>'#DEFAULT#:is-collapsed:t-Region--scrollBody'
,p_plug_template=>2664334895415463485
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(35647016331501325)
,p_plug_name=>'anual-puntos-win-datos'
,p_title=>'Datos'
,p_parent_plug_id=>wwv_flow_imp.id(35646988954501324)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(35647184700501326)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_enable_mail_download=>'Y'
,p_owner=>'JORTRI'
,p_internal_uid=>35647184700501326
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35647237985501327)
,p_db_column_name=>'TEMPORADA'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Temporada'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35647327632501328)
,p_db_column_name=>'EQUIPO'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Equipo'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35647476152501329)
,p_db_column_name=>'PROVEEDOR'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Proveedor'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35647578952501330)
,p_db_column_name=>'PUNTOS'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Puntos'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(35673759228829639)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'356738'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'TEMPORADA:PROVEEDOR:PUNTOS:'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(35647630800501331)
,p_name=>'anual-puntos-win-top'
,p_title=>'Top'
,p_parent_plug_id=>wwv_flow_imp.id(35646988954501324)
,p_template=>2100526641005906379
,p_display_sequence=>20
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(35647736486501332)
,p_query_column_id=>1
,p_column_alias=>'PROVEEDOR'
,p_column_display_sequence=>10
,p_column_heading=>'Proveedor'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(35647854908501333)
,p_query_column_id=>2
,p_column_alias=>'PUNTOS'
,p_column_display_sequence=>20
,p_column_heading=>'Puntos'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(35648297556501337)
,p_plug_name=>'anual-puntos-fantasy'
,p_title=>'Puntos Fantasy'
,p_parent_plug_id=>wwv_flow_imp.id(33532574622593842)
,p_region_template_options=>'#DEFAULT#:js-showMaximizeButton:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(35648372878501338)
,p_region_id=>wwv_flow_imp.id(35648297556501337)
,p_chart_type=>'scatter'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(35648453762501339)
,p_chart_id=>wwv_flow_imp.id(35648372878501338)
,p_seq=>10
,p_name=>'ProveedorPuntoFantasy'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'  AND PR.idfantasyplayer = PO.idfantasyplayer',
'  and PR.idfantasyworkteam = :P5_EQUIPOFANTASY',
'  AND PO.idfantasyworkteam = :P5_EQUIPOFANTASY',
'GROUP BY SU.name, su.colour, FS.SEASON'))
,p_ajax_items_to_submit=>'P5_EQUIPOFANTASY'
,p_series_name_column_name=>'PROVEEDOR_SERIE'
,p_items_x_column_name=>'TEMPORADA_X'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(35648514965501340)
,p_chart_id=>wwv_flow_imp.id(35648372878501338)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_min=>2021
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(35648603323501341)
,p_chart_id=>wwv_flow_imp.id(35648372878501338)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(35648884371501343)
,p_plug_name=>'anual-puntos-fantasy-datos-top'
,p_title=>'Datos - Top'
,p_parent_plug_id=>wwv_flow_imp.id(35648297556501337)
,p_region_template_options=>'#DEFAULT#:is-collapsed:t-Region--scrollBody'
,p_plug_template=>2664334895415463485
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(35648997080501344)
,p_plug_name=>'anual-puntos-fantasy-datos'
,p_title=>'Datos'
,p_parent_plug_id=>wwv_flow_imp.id(35648884371501343)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(35649061050501345)
,p_max_row_count=>'1000000'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
...
,p_enable_mail_download=>'Y'
,p_owner=>'JORTRI'
,p_internal_uid=>35649061050501345
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35649161621501346)
,p_db_column_name=>'TEMPORADA'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Temporada'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35649295084501347)
,p_db_column_name=>'EQUIPO'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Equipo'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35649391516501348)
,p_db_column_name=>'PROVEEDOR'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Proveedor'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(35649451963501349)
,p_db_column_name=>'PUNTOS'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Puntos'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(35689829951881538)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'356899'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'TEMPORADA:PROVEEDOR:PUNTOS:'
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(35649531526501350)
,p_name=>'anual-puntos-fantasy-top'
,p_title=>'Top'
,p_parent_plug_id=>wwv_flow_imp.id(35648884371501343)
,p_template=>2100526641005906379
,p_display_sequence=>20
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(35675415642851501)
,p_query_column_id=>1
,p_column_alias=>'PROVEEDOR'
,p_column_display_sequence=>10
,p_column_heading=>'Proveedor'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(35675544653851502)
,p_query_column_id=>2
,p_column_alias=>'PUNTOS'
,p_column_display_sequence=>20
,p_column_heading=>'Puntos'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(35643191689474441)
,p_name=>'P5_EQUIPOFANTASY'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(33532574622593842)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(33532952144593846)
,p_computation_sequence=>10
,p_computation_item=>'P5_EQUIPOFANTASY'
,p_computation_point=>'BEFORE_BOX_BODY'
,p_computation_type=>'ITEM_VALUE'
,p_computation=>'ID_EQUIPO_FANTASY_INICIO'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(33532644898593843)
,p_name=>'Cargar equipo global'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P5_EQUIPOFANTASY'
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'change'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(33532785115593844)
,p_event_id=>wwv_flow_imp.id(33532644898593843)
,p_event_result=>'TRUE'
...
'BEGIN',
'    :ID_EQUIPO_FANTASY_INICIO := :P5_EQUIPOFANTASY;',
'    SELECT WORKTEAM',
...
'END;',
''))
,p_attribute_02=>'P5_EQUIPOFANTASY'
,p_attribute_05=>'PLSQL'
,p_wait_for_result=>'Y'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(33532861417593845)
,p_event_id=>wwv_flow_imp.id(33532644898593843)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(35644875748501303)
,p_name=>unistr('Refrescar Gr\00E1ficos')
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P5_EQUIPOFANTASY'
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(35644939084501304)
,p_event_id=>wwv_flow_imp.id(35644875748501303)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(33533122692593848)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(35646273687501317)
,p_event_id=>wwv_flow_imp.id(35644875748501303)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(35645139368501306)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(35646353222501318)
,p_event_id=>wwv_flow_imp.id(35644875748501303)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(35645848139501313)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(35647967087501334)
,p_event_id=>wwv_flow_imp.id(35644875748501303)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(35646405496501319)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(35648073644501335)
,p_event_id=>wwv_flow_imp.id(35644875748501303)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(35647016331501325)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(35648112643501336)
,p_event_id=>wwv_flow_imp.id(35644875748501303)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(35647630800501331)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(35675610238851503)
,p_event_id=>wwv_flow_imp.id(35644875748501303)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(35648297556501337)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(35675773661851504)
,p_event_id=>wwv_flow_imp.id(35644875748501303)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(35648997080501344)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(35675820216851505)
,p_event_id=>wwv_flow_imp.id(35644875748501303)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(35649531526501350)
,p_attribute_01=>'N'
);
